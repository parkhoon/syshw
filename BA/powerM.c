...
void main(int argc, char *argv[]){
	...
	if(signal(SIGUSR1, sig_saving)== SIG_ERR) perror("SIGUSR1 ERROR\n");
	if(signal(SIGUSR2, sig_normal)== SIG_ERR) perror("SIGUSR2 ERROR\n");
